...
public class SetSecurityQuestionsActivity extends AppCompatActivity {
    ...
    private void setAnswers() {
        ...
        if(answer1.equals("") || answer2.equals("") || answer3.equals(""))
            Toast.makeText(SetSecurityQuestionsActivity.this, "Veuillez répondre à toutes les questions", Toast.LENGTH_SHORT).show();
        else{
            ...
            ref.child("Security Questions").updateChildren(userDataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Intent intent = new Intent(SetSecurityQuestionsActivity.this, SettinsActivity.class);
                        startActivity(intent);
                        finish();

                        Toast.makeText(SetSecurityQuestionsActivity.this, "Vous avez défini avec succès vos questions de sécurité", Toast.LENGTH_SHORT).show();
                    }
