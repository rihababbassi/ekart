...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    private TextView productPrice,productDescription,productName, productTva;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productTva = (TextView) findViewById(R.id.product_tva_details);
        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (state.equals("Order Placed") || state.equals("Order Shipped")){
                    Toast.makeText(ProductDetailsActivity.this,"Vous pouvez acheter plus de produit, une fois votre commande expédiée ou confirmée.",Toast.LENGTH_LONG).show();
                }
                else
                {
                    addingToCartList();
    ...
    private void addingToCartList() {
        ...
        cartMap.put("tva",productTva.getText().toString());
        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    productTva.setText(products.getTva());
