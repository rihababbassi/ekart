...
public class ConfirmFinalOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Prix total = Dt. "+totalAmount,Toast.LENGTH_SHORT).show();
    ...
    private void Check() {
        if(TextUtils.isEmpty(nameEditText.getText().toString())){
            ...
            Toast.makeText(this,"Veuillez fournir votre adresse valide.",Toast.LENGTH_SHORT).show();
        }
                ...
                if (task.isSuccessful()){
                    FirebaseDatabase.getInstance().getReference()
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        Toast.makeText(ConfirmFinalOrderActivity.this,"Votre commande finale a été passée avec succès.",Toast.LENGTH_SHORT).show();
